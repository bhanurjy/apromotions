...
define( "RECIPIENT_NAME", "Academic Promotions" );
define( "RECIPIENT_EMAIL", "info@leratechit.com" );
...
if ( $fname && $senderEmail && $message ) {
 ...
 // echo "<p class='success'>Thanks for contacting us. We will contact you ASAP!</p>";
  echo '<script>alert("Thanks for contacting us. We will contact you ASAP!")</script>';
  header("Refresh: 0.100; url=http://academicpromotions.net/");
}
